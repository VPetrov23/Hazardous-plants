...
Обучите модель на предложенных параметры. Проанализируйте полученные графики Training and Validation Accuracy и Training and Validation Loss.
...
Далее с ней можно работать в блокноте **Plant classification.ipynb**
